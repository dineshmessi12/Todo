...
const Todo = () => {
    ...
    function onSubmit(values) {
        ...
        if (id === -1) {
            console.log("create ")
            console.log(todo)
            createTodoApi(username, {username,description,targetDate,done:false}).then(response => navigate("/todos")).catch(error=>(console.log(error)))
        } else {
            console.log(id," update the todo >>>>>>>>>>>>>>")
